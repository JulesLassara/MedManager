...
if(isset($_POST['step2'])) {
    if(!isset($_POST['id_med'])) $medecinmissing = 1;
        ...
        header('Location: addConsult3.php?id_usager='.$_GET['id_usager']."&id_medecin=".$_POST['id_med']."&duree_rdv=".$_POST['duree_rdv']);
    }
}
?>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading">
                    <h1>Consultations</h1>
                    <span class="subheading">Ajout d'une consultation - Choix du médecin et de la durée de la consultation</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <form method="POST">
                ...
                <div class="form-group submit-center">
                    ...
                    <button type="submit" class="btn btn-success" name="step2">Choix de la date</button>
                </div>
            </form>
